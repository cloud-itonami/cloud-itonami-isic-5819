# Operator Quickstart — Other publishing activities

Shortest path from clone to a verified local dry-run for **ISIC 5819** (`cloud-itonami-isic-5819`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5819.git
cd cloud-itonami-isic-5819
```
...
- Blueprint governor key: `specpub-governor`
- Likely source path: `specpubops.governor.cljc`
